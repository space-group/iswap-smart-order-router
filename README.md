...
JSON_RPC_PROVIDER_BITLAYER = '<JSON_RPC_PROVIDER>'
JSON_RPC_PROVIDER_BITLAYER_TESTNET = '<JSON_RPC_PROVIDER>'
JSON_RPC_PROVIDER_CYBER = '<JSON_RPC_PROVIDER>'
JSON_RPC_PROVIDER_CYBER_TESTNET = '<JSON_RPC_PROVIDER>'
JSON_RPC_PROVIDER_LINEA = '<JSON_RPC_PROVIDER>'
JSON_RPC_PROVIDER_LINEA_SEPOLIA = '<JSON_RPC_PROVIDER>'
```
