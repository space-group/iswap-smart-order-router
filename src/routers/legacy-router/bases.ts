...
export const BASES_TO_CHECK_TRADES_AGAINST = (
  ...
  return {
    ...
    [ChainId.BITLAYER]: [WRAPPED_NATIVE_CURRENCY[ChainId.BITLAYER]],
    ...
    [ChainId.CYBER_TESTNET]: [WRAPPED_NATIVE_CURRENCY[ChainId.CYBER_TESTNET]],
    [ChainId.LINEA]: [WRAPPED_NATIVE_CURRENCY[ChainId.LINEA]],
    [ChainId.LINEA_SEPOLIA]: [WRAPPED_NATIVE_CURRENCY[ChainId.LINEA_SEPOLIA]],
